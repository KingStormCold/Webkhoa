                                    ...
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" onclick="update(this)"
                                               data-toggle="tooltip" title="<fmt:message key='label.insert.all' bundle='${lang}'/>">
                                                <span>
                        ...
                        <fmt:bundle basename="ApplicationResources">
                            <display:table id="tableList" name="items.listResult" partialList="true" size="${items.totalItems}"
                                ...
                                <display:column title="<fieldset class='form-group'>
                                    ...
                                    <fieldset>
                                        <input type="checkbox" name="checkList" id="checkboz_${tableList.userId}" value="${tableList.userId}" />
                                    </fieldset>
                                </display:column>
...
<script>
    $(document).ready(function () {
        //load modal bang jsp khac sau do moi hien thi toogle
    ...
    function update(btn) {
        ...
        //them moi se nhay vao day con hk co se la update
