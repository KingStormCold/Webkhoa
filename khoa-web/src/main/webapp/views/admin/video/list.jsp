...
<c:url var="requestUrl" value="/admin-video-list.html"/>
<c:url value="/admin-video-edit.html" var="videoEditUrl">
    <c:param name="urlType" value="url_edit"/>
</c:url>
<c:url value="/admin-video-list.html" var="formUrl"/>
<html>
<head>
                                        ...
                                        <div class="widget-main">
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label"><fmt:message key="label.video.title" bundle="${lang}"/></label>
                                                    <div class="col-sm-8">
                                                        <div class="fg-line">
                                ...
                                <div class="table-btn-controls">
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <c:url var="addUrl" value="/admin-video-edit.html">
                                                <c:param name="urlType" value="url_edit"/>
                                            </c:url>
                            ...
                            <fmt:bundle basename="ApplicationResources">
                                <display:table id="tableList" name="items.listResult" partialList="true" size="${items.totalItems}"
                                    ...
                                    <display:column title="<fieldset class='form-group'>
                                        ...
                                        <fieldset>
                                            <input type="checkbox" name="checkList" id="checkboz_${tableList.idVideo}" value="${tableList.idVideo}" />
                                        </fieldset>
                                    </display:column>
                                    <display:column property="tieuDe" titleKey="label.video.title" sortable="true" sortName="tieuDe"/>
                                    <display:column property="link" titleKey="label.video.link" sortable="true" sortName="link"/>
                                    <display:column property="status" titleKey="label.video.status" sortable="true" sortName="status"/>
                                    <display:column property="file" titleKey="label.video.home" sortable="true" sortName="file"/>
                                    <display:column headerClass="col-actions" titleKey="label.action">
                                        <c:url var="editUrl" value="/admin-video-edit.html">
                                            <c:param name="urlType" value="url_edit"/>
                                            <c:param name="pojo.idVideo" value="${tableList.idVideo}"/>
                                        </c:url>
